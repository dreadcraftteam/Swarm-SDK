...
#ifdef USE_BACKGROUND_MOVIES
#include "BackGroundVideo.h"
#endif // USE_BACKGROUND_MOVIES
...
ConVar gameui_debug( "gameui_debug", "0", FCVAR_RELEASE );
...
void CBaseModPanel::PaintBackground()
{
	...
	if ( !m_bLevelLoading && !GameUI().IsInLevel() && !GameUI().IsInBackgroundLevel() )
	{
		int wide, tall;
		GetSize( wide, tall );
