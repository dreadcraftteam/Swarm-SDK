...
const QAngle g_SurfaceRenderAnglesAngles( 0.0f, 0.0f, 0.0f );
...
void Surface_SafeLightCubeUpdate( const Vector &vecRenderOrigin, Vector4D *cachedCubeColours )
{
	...
	// FIXME: we need more complex lighting data for isosurfaces anyway (per-vertex light sample indices ala skinning, or UVWs into a light sample texture)
